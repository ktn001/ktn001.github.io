...
La valeur retournée par le calcul peut être une chaine de caractères, un numérique ou un boolean. Les valeurs
`'0'`, `0` et `false` signifie qu'il ne pleut pas. Dans tous les autres cas, on considère qu'il pleut.
