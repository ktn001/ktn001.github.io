...
+ Sélectionner
    ...
    + Sélectionner `Créer compteur de tentatives` si l'on désire avoir une info qui indique combien de fois la commande a dû être envoyée pour le dernier enclenchement ou déclenchement.
    + Sélectionner `Créer statut` si l'on désire avoir une info qui indique le statut de l'exécution de la dernière commande.
...
* La commande 1406 est la commande d'enclenchement.
* La commande 1407 est la commande de déclenchement.
* Etat est l'info de retour pour les commandes d'enclenchement et de déclenchement.
* Les commandes d'enclenchement et de déclenchement seront répétées au maximum 5 fois toutes les 3 secondes.
* La valeur des options des commandes ont été reprises des commandes liées.
* La commande 1410 contiendra le nombre d'envois de la commande lors du dernier enclenchement/déclenchement qui a été créée.
...
+ Sélectionner le nom de la commande de retour d'état (celle que nous avons créée ci-dessus).
...
+ Saisir le nombre de répétitions maximum et l'intervalle entre ces répétitions. 
+ Cliquer sur sauvegarder.
...
+ Sélectionner le sous-type qui doit être le même que celui de la commande liéée.
+ Saisir les options de la commande (on reprend généralement les options de la commande liée).
+ Cliquer sur sauvegarder.
