...
El complemento **Fallos** permite detectar fallos comprobando la coherencia entre un estado y una lectura.
...
- La bomba está en marcha, pero no sale agua.
...
# Los equipos
{: .num}
Un equipo **Defectos** permite supervisar la coherencia de varias combinaciones de estado y valor. Una nota informativa
indica, para cada una de estas supervisiones, si la situación actual es coherente o no.
...
## Creación
{: .num}
Los equipos **de fallos** se crean en la página del complemento, a la que se puede acceder a través del menú «Complementos» ==> «Monitorización» ==> «Fallos».
...
* ***Medida:*** Información digital a tener en cuenta.
...
* ***Visualización invertida:*** Inversión del valor en la pantalla (permite que el icono sea verde si todo va bien y rojo en caso de fallo).
...
* ***Consigna:*** Información digital, valor que debe alcanzar la vivienda.
...
* ***Tempoinspiration:*** Periodo, en segundos, durante el cual se desactiva la supervisión tras un cambio de ***estado***.
...
El comando *historial* y su widget permiten ver los cinco últimos fallos que se han producido. El número de eventos que aparecen en la lista se puede configurar.

Se puede configurar un periodo de retención para los eventos de la lista. Los eventos que hayan tenido lugar antes de que finalice dicho periodo se eliminan de la lista. Así, los eventos que hayan tenido lugar hace más de dos días se eliminan de la lista si el periodo de retención es de dos días.
...
* ***Mostrar:*** Indica si se debe mostrar o no el widget.
...
| :---- | :----:  | :----: | :---- |
| Situación inicial: | ![](/images/defauts/defauts_initial.png «Estado inicial») | ![](/images/defauts/defauts_initial_bw.png «Estado inicial») | No hay fallos. Los sistemas de vigilancia están en estado normal. |
| 1<sup>Primera</sup> alerta de estado anormal | ![](/images/defauts/defauts_premier_defaut.png) | ![](/images/defauts/defauts_premier_defaut_bw.png) | El icono de fallo indica que se ha producido una anomalía que no se ha resuelto. |
